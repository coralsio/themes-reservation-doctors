                    ...
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">@lang('reservation-doctors::labels.partial.my_profile')</li>
                        </ol>
                    </nav>
                    <h2 class="breadcrumb-title">@lang('reservation-doctors::labels.partial.my_profile')</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <li class="nav-item">
                        <a href="#profile" class="nav-link {{ $active_tab=="profile"? 'active':'' }}"
                           role="tab" data-toggle="tab">
                            @lang('reservation-doctors::labels.doctors.profile_settings')
                        </a>
                    </li>
                    ...
                    <div class="tab-pane {{ $active_tab=="profile"? 'active':'' }}" id="profile" role="tabpanel">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-pills mt-2">
                                    <li class="nav-item"><a href="#edit_profile" class="nav-link active"
                                                            data-toggle="tab"
                                                            aria-expanded="false">
                                            <i class="fa fa-pencil"></i> @lang('reservation-doctors::labels.auth.edit_profile')
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#profile_addresses" class="nav-link" data-toggle="tab"><i
                                                    class="fa fa-map-marker"></i>
                                            @lang('reservation-doctors::labels.auth.addresses')</a>
                                    ...
                                    <li class="nav-item">
                                        <a href="#reset_password" class="nav-link" data-toggle="tab"><i
                                                    class="fa fa-lock"></i>
                                            @lang('reservation-doctors::labels.auth.auth_password')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#notification_preferences" class="nav-link" data-toggle="tab"><i
                                                    class="fa fa-bell-o"></i>
                                            @lang('reservation-doctors::labels.auth.notification_preferences')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="text-center">
                                                    ...
                                                    <small class="d-block">@lang('reservation-doctors::labels.auth.click_pic_update')</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="notification_preferences">
                                        ...
                                        @empty
                                            <div class="alert alert-info"><h5
                                                        class="text-center">@lang('reservation-doctors::labels.auth.no_notification')</h5>
                                            </div>
                                        @endforelse
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        {!! CoralsForm::formButtons(trans('reservation-doctors::labels.auth.save',['title' => $title_singular]),[],['href'=>url('dashboard')]) !!}
                                    </div>
